...
#ifndef FOCALLY_SWIFT_H
#define FOCALLY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Focally",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Focally11AppDelegate")
...
@interface AppDelegate (SWIFT_EXTENSION(Focally)) <NSMenuDelegate>
@end

@class ASWebAuthenticationSession;
SWIFT_CLASS("_TtC7Focally21GoogleCalendarService")
@interface GoogleCalendarService : NSObject <ASWebAuthenticationPresentationContextProviding>
...
SWIFT_CLASS("_TtC7Focally19NotificationService")
